                    ...
                    <tr style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                        <td style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;mso-table-lspace: 0pt !important;mso-table-rspace: 0pt !important;">
                            <div class="text" style="padding: 0 4em;text-align: center;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: rgba(255, 255, 255, .9);">
                                ...
                                <h2 style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: Josefin Sans, sans-serif;color: #fff;margin-top: 0;font-weight: 600;font-size: 40px;margin-bottom: 0;line-height: 1;text-transform: uppercase;">{{env('APP_NAME', 'The App')}} is Live!</h2>
                                <p style="font-family: 'Josefin Sans', sans-serif;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">Thank you for Waiting for us. We have finally gone live! Have a look for yourself.</p>
                                <p style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                                    <a href="{{url('/')}}" class="btn btn-primary"
                                       style="-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;text-decoration: none;color: #ffffff;padding: 5px 15px;display: inline-block;border-radius: 30px;background: #448ef6;">Visit Us</a>
                            </div>
                        </td>
                    </tr>
                </table>
